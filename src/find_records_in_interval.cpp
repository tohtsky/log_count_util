...
py::array_t<int64_t> find_records_within_interval_within_query_new(
...
PYBIND11_MODULE(_core, m) {
  m.def("find_records_within_interval",
        &find_records_within_interval_within_query_new<int64_t, int64_t>,
  ...
  m.def("find_last_record_index_f", &find_last_record_index<float, int64_t>,
        py::arg("query_ids"), py::arg("query_datetime"), py::arg("target_id"),
        py::arg("target_datetime"));
